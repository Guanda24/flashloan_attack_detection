...
for i in tqdm(range(len(Uniswap_v3_flashloan_unique)), desc='Processing transactions with default abi'):
...
if Uniswap_v3_ABC_error_index:
    for i in tqdm(range(len(Uniswap_v3_ABC_error_index)), desc='Processing error transactions'):
