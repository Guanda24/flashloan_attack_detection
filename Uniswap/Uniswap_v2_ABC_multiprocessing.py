...
# File Lock Path
Uniswap_v2_ABC_lock_path = '/local/scratch/exported/MP_Defi_txs_TY_23/guanda/Uniswap_v2_ABC.lock'
Uniswap_v2_ABC_error_tx_cant_be_solved_lock_path = '/local/scratch/exported/MP_Defi_txs_TY_23/guanda/Uniswap_v2_ABC_error_tx_cant_be_solved.lock'
...
def process_transaction_with_default_abi(i):
    ...
    try:    
        block_number = Uniswap_v2_flashloan_unique['block_number'][i]
        logIndex = Uniswap_v2_flashloan_unique['logIndex'][i]
        ...
        flashloan_amount = Uniswap_v2_flashloan_unique['amount'][i]
        ...
        with FileLock(Uniswap_v2_ABC_lock_path):
...
def process_error_transaction(i):
    ...
    try:
        ...
        if tx_hash not in Uniswap_v2_ABC_error_tx_cant_be_solved:
            with FileLock(Uniswap_v2_ABC_error_tx_cant_be_solved_lock_path):
