...
tx_hash_list = v3_daily_flash_tx_unique['tx_hash'].tolist()
...
token_address_df.to_csv('/local/scratch/exported/MP_Defi_txs_TY_23/guanda/v3_flashloan_unique_token.csv', index=False)