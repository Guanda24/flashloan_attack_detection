...
tx_hash_list = Uniswap_v2_flashloan_unique['tx_hash'].tolist()
...
token_address_df.to_csv('/local/scratch/exported/MP_Defi_txs_TY_23/guanda/Uniswap_v2_unique_token.csv', index=False)