...
for i in tqdm(range(len(Balancer_v2_flashloan_unique)), desc='Processing transactions with default abi'):
...
if Balancer_v2_ABC_error_index:
    for i in tqdm(range(len(Balancer_v2_ABC_error_index)), desc='Processing error transactions'):
