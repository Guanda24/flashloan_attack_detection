...
flash_tx_unique = pd.read_csv('/local/scratch/exported/MP_Defi_txs_TY_23/guanda/Balancer_v2_flashloan_unique.csv')
...
token_address_df.to_csv('/local/scratch/exported/MP_Defi_txs_TY_23/guanda/Balancer_v2_unique_token.csv', index=False)